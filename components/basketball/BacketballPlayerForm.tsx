...
export const BasketballPlayerForm: React.FC<BasketballTemplateFormProps> = ({
  ...
  const handleComplete = () => {
       const playerData: BasketballPlayerData = {
        ...
        presentationVideo,
        stats: {
          pointsPerGame: pointsPerGame ? parseFloat(pointsPerGame) : 0,
          reboundsPerGame: reboundsPerGame ? parseFloat(reboundsPerGame) : 0,
          assistsPerGame: assistsPerGame ? parseFloat(assistsPerGame) : 0,
          stealsPerGame: stealsPerGame ? parseFloat(stealsPerGame) : 0,
          blocksPerGame: blocksPerGame ? parseFloat(blocksPerGame) : 0,
          fieldGoalPercentage: fieldGoalPercentage ? parseFloat(fieldGoalPercentage) : 0,
          threePointPercentage: threePointPercentage ? parseFloat(threePointPercentage) : 0,
          freeThrowPercentage: freeThrowPercentage ? parseFloat(freeThrowPercentage) : 0,
          gamesPlayed: gamesPlayed ? parseInt(gamesPlayed) : 0,
          minutesPerGame: minutesPerGame ? parseFloat(minutesPerGame) : 0,
        },
        email,
        phone,
        instagram,
